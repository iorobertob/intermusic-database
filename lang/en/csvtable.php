...
$string['csvtable:name'] = 'Name';
$string['csvtable:edit'] = 'Edit test';
$string['csvtable:enrol'] = 'Enrol users';
$string['csvtable:manage'] = 'Manage users';
$string['csvtable:unenrol'] = 'Unenrol users';
$string['csvtable:view'] = 'View test';
